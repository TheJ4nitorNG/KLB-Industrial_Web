    ...
    <div className="flex flex-col min-h-screen bg-industrial-paper">
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto w-full flex-grow">
        <div className="grid md:grid-cols-2 gap-10">
          ...
          {/* RESOURCE CARD 1 */}
          <div className="bg-white border border-gray-200 shadow-sm flex flex-col h-full hover:border-industrial-slate transition-colors border-t-8 border-t-industrial-charcoal">
            <div className="p-8 flex-grow">
              ...
              <h2 className="text-2xl font-black text-industrial-slate mb-4 uppercase tracking-wide">
            ...
            <div className="p-8 pt-0 mt-auto">
              <a 
                ...
                className="w-full inline-flex justify-center items-center gap-3 bg-industrial-slate hover:bg-industrial-orange text-white font-bold py-4 px-6 uppercase tracking-wider transition-colors border-2 border-industrial-slate hover:border-industrial-orange"
              >
                Download PDF
          ...
          {/* RESOURCE CARD 2 */}
          <div className="bg-white border border-gray-200 shadow-sm flex flex-col h-full hover:border-industrial-slate transition-colors border-t-8 border-t-industrial-orange">
            <div className="p-8 flex-grow">
